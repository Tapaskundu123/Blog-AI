    ...
    <>
      <div className='relative min-h-screen'>
        <div className="flex flex-col justify-center items-center"> 
           ...
           <form onSubmit={HandleSubmit} className='w-[80%] bg-white border rounded-xl flex justify-between gap-1 sm:w-[40%]  '>
              <input type="text" placeholder='Search for Blogs' className='pl-4 w-full outline-none border-none '/>
              <button className='bg-primary border py-2 px-6 my-1 mr-1 rounded-xl cursor-pointer text-white sm:py-3'>Seacrh</button>
           </form>
         </div>
